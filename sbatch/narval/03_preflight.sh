#!/bin/bash
# ============================================================================
# sbatch/narval/03_preflight.sh — narval's entry point for this stage.
# ============================================================================
# ⛔⛔ THERE IS NO SECOND COPY OF THIS STAGE, AND THAT IS ON PURPOSE.
#   The implementation lives in sbatch/fir/03_preflight.sh and is shared by
...
[ -f sbatch/fir/03_preflight.sh ] || { echo "⛔ the shared implementation sbatch/fir/03_preflight.sh is missing"; exit 1; }
export LRS_ENV="sbatch/narval/narval_env.sh"
export LRS_STAGE_DIR="sbatch/narval"
exec bash "sbatch/fir/03_preflight.sh" "$@"
